...
if (month == 1) {
  ...
  if (day <= 19) {
    ...
    console.log(" balık burcusunuz ");
  }
} else if (month == 3) {
  if (day <= 20) {
    console.log(" balık burcusunuz ");
  } else {
    console.log(" koç burcusunuz ");
  }
} else if (month == 4) {
  if (day <= 20) {
    console.log(" koç burcusunuz ");
  } else {
    console.log(" boğa burcusunuz ");
  }
} else if (month == 5) {
  if (day <= 20) {
    console.log(" boğa burcusunuz ");
